...
{
    public class ColetaMercadoriasRepositorio : GenericoRepositorio<ColetaMercadoria>, IColetaMercadoriasRepositorio
    {
      public ColetaMercadoriasRepositorio(ISession session) : base(session)
      {
